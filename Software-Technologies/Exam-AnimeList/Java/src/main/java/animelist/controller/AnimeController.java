...
public class AnimeController {
	...
	public String createProcess(Model model, AnimeBindingModel animeBindingModel) {
		...
		if (animeBindingModel.getRating() < 0 || animeBindingModel.getName().equals("")
				|| animeBindingModel.getDescription().equals("") || animeBindingModel.getWatched().equals("")){
			return "redirect:/";
		}

		Anime anime = new Anime(animeBindingModel.getRating(), animeBindingModel.getName(),
				animeBindingModel.getDescription(), animeBindingModel.getWatched());
